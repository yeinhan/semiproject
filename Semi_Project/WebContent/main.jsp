  ...
  <div class="book js-flickity" data-flickity-options='{ "wrapAround": true }'>
   ...
   <div class="book-cell" >
    ...
    <div class="book-content">
     ...
     <div class="book-see" onclick="location.href='pagemove?command=contentpage'">더 보기</div>
    </div>
   </div>
   <div class="book-cell" >
    <div class="book-img">
    ...
    <div class="book-content">
     ...
     <div class="book-see book-blue" onclick="location.href='pagemove?command=contentpage'">더 보기</div>
    </div>
   </div>
   <div class="book-cell">
    <div class="book-img">
    ...
    <div class="book-content">
     ...
     <div class="book-see book-pink" onclick="location.href='pagemove?command=contentpage'">더 보기</div>
    </div>
   </div>
   <div class="book-cell">
    <div class="book-img">
...
2019년 6월 11일 공개된 리그 오브 레전드의 새로운 모드의 게임. 공식 명칭은 Teamfight Tactics</div>
     <div class="book-see book-yellow" onclick="location.href='pagemove?command=contentpage'">더 보기</div>
    </div>
   </div>
   <div class="book-cell">
    <div class="book-img">
    ...
    <div class="book-content">
     ...
     <div class="book-see book-purple" onclick="location.href='pagemove?command=contentpage'">더 보기</div>
    </div>
   </div>
  </div>
 </div>
   ...
   <div class="week year">
    ...
    <div class="year-book">
     ...
     <div class="year-book-content">
      <div class="year-book-name"><b onclick="location.href='pagemove?command=contentpage'">세키로 : 섀도우 다이 트와이스</b></div>
    ...
    <div class="year-book">
     ...
     <div class="year-book-content">
      <div class="year-book-name"><b onclick="location.href='pagemove?command=contentpage'">언챠티드 4</b></div>
    ...
    <div class="year-book">
     ...
     <div class="year-book-content">
      <div class="year-book-name"><b onclick="location.href='pagemove?command=contentpage'">데스 스트랜딩 </b></div>
    ...
    <div class="year-book">
     ...
     <div class="year-book-content">
      <div class="year-book-name"><b onclick="location.href='pagemove?command=contentpage'">마블 스파이더맨</b></div>
    ...
    <div class="year-book">
     ...
     <div class="year-book-content">
      <div class="year-book-name"><b onclick="location.href='pagemove?command=contentpage'">더 위쳐 : 와일드헌터 3</b></div>
    ...
    <div class="year-book">
     ...
     <div class="year-book-content">
      <div class="year-book-name"><b onclick="location.href='pagemove?command=contentpage'">스타워즈 : 제다이 오더의 몰락</b></div>
    ...
    <div class="year-book">
     ...
     <div class="year-book-content">
      <div class="year-book-name"><b onclick="location.href='pagemove?command=contentpage'">레지던트 이블 2</b></div>
    ...
    <div class="year-book">
     ...
     <div class="year-book-content">
      <div class="year-book-name"><b onclick="location.href='pagemove?command=contentpage'">컨트롤</b></div>
    ...
    <div class="year-book">
     ...
     <div class="year-book-content">
     <div class="year-book-name"><b onclick="location.href='pagemove?command=contentpage'">데빌 메이 크라이 5</b></div>
      <div class="year-book-author">캡콤</div>
     </div>
    </div>
   </div>
  ...
  <div class="popular-books">
   <div class="main-menu">
    ...
    <div class="book-types">
     <a class="book-type active"> All Platforms</a>
   ...
   <div class="book-cards">
    <div class="book-card">
     ...
     <div class="book-name" onclick="location.href='pagemove?command=contentpage'">사이버펑크 2077</div>
...
<label class="full" for="star-c5"></label>
    ...
    <div class="book-card">
     ...
     <div class="card-content">
     <div class="book-name" onclick="location.href='pagemove?command=contentpage'">젤다의 전설 : 야생의숨결</div>
...
<label class="full" for="star-c10"></label>
    ...
    <div class="book-card">
     ...
     <div class="card-content">
     <div class="book-name" onclick="location.href='pagemove?command=contentpage'">모여봐요 동물의 숲</div>
      <div class="book-by">닌텐도</div>
      <div class="rate">
<fieldset class="rating book-rate">
...
<label class="full" for="star-c15"></label>
    ...
    <div class="book-card">
     ...
     <div class="card-content">
     <div class="book-name" onclick="location.href='pagemove?command=contentpage'">헤일로 5</div>
...
<label class="full" for="star-c20"></label>
    ...
    <div class="book-card">
     ...
     <div class="card-content">
     <div class="book-name" onclick="location.href='pagemove?command=contentpage'">발로란트</div>
...
<label class="full" for="star-c25"></label>
    ...
    <div class="book-card">
     ...
     <div class="card-content">
     <div class="book-name" onclick="location.href='pagemove?command=contentpage'">오리와 도깨비불</div>
...
<label class="full" for="star-c5"></label>
    ...
    <div class="book-card">
     ...
     <div class="card-content">
     <div class="book-name" onclick="location.href='pagemove?command=contentpage'">데스페라도 3</div>
...
<label class="full" for="star-c5"></label>
    ...
    <div class="book-card">
     ...
     <div class="card-content">
     <div class="book-name" onclick="location.href='pagemove?command=contentpage'">오버워치 2</div>
