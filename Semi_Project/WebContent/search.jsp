      ...
      <div class="main-wrapper">
         ...
         <div class="popular-books">
            ...
            <c:choose>
                      ...
                      <img alt="#" src="https://miro.medium.com/max/1400/1*zRvYJWeLF5dcxM1G2hcEHA.jpeg">
           ...
           <div class="book-cards" style="grid-template-columns: repeat(1, 1fr)">
               <div class="book-card">
            	 ...
            	 <a href="pagemove?command=contentpage&game_no=${dto.game_no }" class="reviewmore2" >게임 더 보기</a>
            </c:forEach>
               ...
               <c:choose>
                  ...
                  <c:otherwise>
                     <c:forEach var="dto" items="${dto }" begin="0" end="3" step="1">
                      ...
                      <a href="pagemove?command=contentpage_more&${dto.game_no }" class="reviewmore" >리뷰 더 보기</a>
                  </c:otherwise>
               </c:choose>
            </div>
         </div>
