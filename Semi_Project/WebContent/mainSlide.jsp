    ...
    <div class="book-content">
     ...
     <div class="rate">
      ...
      <div class="rate_image" style="margin-top : 15%;">
     		<img alt="" src="https://opencritic.com/assets/tiers/mighty-man.png" style="height : 70px;">
     		</div>
      </c:when>
      ...
      <div class="rate_image" style="margin-top : 15%;">
     		<img alt="" src="https://opencritic.com/assets/tiers/strong-man.png" style="height : 70px;">
     		</div>
      </c:when>
      ...
      <div class="rate_image" style="margin-top : 15%;">
     		<img alt="" src="https://opencritic.com/assets/tiers/fair-man.png" style="height : 70px;">
     		</div>
      </c:when>
      ...
      <div class="rate_image" style="margin-top : 15%;">
     		<img alt="" src="https://opencritic.com/assets/tiers/weak-man.png" style="height : 70px;">
     		</div>
      </c:when>
