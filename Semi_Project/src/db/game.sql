...
INSERT INTO REVIEW VALUES(RV_NO.NEXTVAL,'아이디1',1,5,'재밌네',SYSDATE,1);
...
INSERT INTO REVIEW VALUES(RV_NO.NEXTVAL, '아이디1',1,5,'재밌당',SYSDATE,4);

DELETE REVIEW WHERE RV_USER_ID = '아이디1' AND RV_PLATFORM =3;
