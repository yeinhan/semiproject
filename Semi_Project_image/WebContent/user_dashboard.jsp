      ...
      <div class="container">
         <div class="grid_4">
            <section class="box widget locations">
               <div class="avatar">
               <c:forEach var="user_img" items="${user_img }" >
               	<img src="./u_img/${user_img.user_no}/${user_img.user_image}.jpg" style="width:227px; height:222px;">
               </c:forEach>
               </div>
               <div class="details">
                  <h2><%=user_id %></h2>
      ...
      <div class="change-popup">
         ...
         <input type="hidden" name="user_id" value="<%= user_id %>">
            ...
            <label for="psw"><b>비밀번호</b></label> <input type="password"
               placeholder="Enter Password" name="user_pw_ud" required> <label
               for="pswchk"><b>비밀번호 확인</b></label> <input type="password"
               placeholder="Checked Password" name="user_pw_udck"  oninput="pwChk2();"
