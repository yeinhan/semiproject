...
public class GameDto {
	...
	public GameDto(int game_no , int rv_platform, String rv_content , String rv_user_id) {
		super();
	...
	public GameDto(int rv_no, double rv_star, String game_name) {
		super();
		this.rv_no = rv_no;
		this.rv_star = rv_star;
	...
	public GameDto(int rv_no, double rv_star, String rv_content, int rv_platform,String rv_user_id) {
		super();
		this.rv_no = rv_no;
		this.rv_user_id = rv_user_id;
		this.rv_star = rv_star;
