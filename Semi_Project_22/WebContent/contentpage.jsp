...
%>
	...
	<section id="banner"
		style="background-image : url('${dto.game_screenshot2 }')">
		<div class="inner">
			<header>
				<h1>
	...
	<div id="main">
		...
		<section class="wrapper style2">
			...
			<a href="pagemove?command=contentpage_more&game_no=${dto.game_no}"
	...
	<section class="wrapper">
			...
			<div class="form-body">
				<form action="pagemove" method="post" class="review_writeform">
					...
					<textarea rows="5" cols="30" name="rv_content" class="review_area"
						placeholder="리뷰를 작성해 주세요." style="font-size: 30px"></textarea>
					<input type="submit" value="작성">
				</form>
			</div>
	</div>
			...
			<div class="tr_container">
				<div>
					<img src="${dto.main_image } "
						...
						onclick="showVid();">
					<p>
						<br>"The Last of Us Part 2" <br>트레일러 (4K)
					</p>
		...
		<div class="wrapper">
			...
			<div class="article-wrapper">
				<div class="card-header">
					<img alt="#" src="${dto.a_image1 }"
						style="width: 300px; height: 200px; margin-top: 0%;"
						onclick="moveToReview();">
					<div class="card-body">
						<c:out value="${dto.article1 }"></c:out>
						<p class="article-p">
