...
<body>
				...
				<tbody>
					...
					<tr>
						<td colspan="6" align="center" style="text-align: center">
							...
							%> <a
							href="pagemove?command=user_dashboard_pop_pc&pageNum=<%=startPage - 10%>">[이전]</a>
							<%
								}
							...
							%> <a href="pagemove?command=user_dashboard_pop_pc&pageNum=<%=i%>">[<%=i%>]
						</a> <%
 	}
 } // for end
 ...
 %> <a
							href="pagemove?command=user_dashboard_pop_pc&pageNum=<%=startPage + 10%>">[다음]</a>
							<%
								}
							}
							%>
