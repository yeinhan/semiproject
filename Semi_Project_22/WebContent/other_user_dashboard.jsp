						...
						<ul class="reviews user_reviews">
							<li class="user_reviewlist">
								<div class="review_product_image">
									<img
										src="https://static.metacritic.com/images/products/games/8/b175e180d750c5e13222941ff3456d5d-53.jpg"
										alt="#">
								</div>
								<div class="review_container">
									<div class="product_title">
										<span><c:out value="${list.game_name }"></c:out></span>
									</div>
									<div class="product_score">
										<span class="label">리뷰 점수 : <c:out
												value="${list.rv_star }"></c:out></span>
										<table>
											<tr>
												<td class="star_point">
													<div class="rate">
									...
									<div class="review_body">
										<span class="inline_expand_collapse inline_collapsed"
											id="review_blurb_12050815"><span><c:out
